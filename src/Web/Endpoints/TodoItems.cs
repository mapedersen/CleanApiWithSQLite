using CleanApiWithSQLite.Application.Common.Models;
using CleanApiWithSQLite.Application.TodoItems.Commands.CreateTodoItem;
using CleanApiWithSQLite.Application.TodoItems.Commands.DeleteTodoItem;
using CleanApiWithSQLite.Application.TodoItems.Commands.UpdateTodoItem;
using CleanApiWithSQLite.Application.TodoItems.Commands.UpdateTodoItemDetail;
using CleanApiWithSQLite.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace CleanApiWithSQLite.Web.Endpoints;
